...
session_name(PROJECT_SESSION_NAME . 'admin');
session_start();
...
ATTENTION: The trailing slash is required.
*/
$baseDir = $_SERVER["DOCUMENT_ROOT"].'/filestorage/files/';


// /usr/www/svnfolders/dev/miritec/lib/ckfinder/images
/*
 * ### Advanced Settings
 */
...
$config['ResourceType'][] = Array(
		...
		'directory' => $baseDir . '',
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pps,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,zip',
		'deniedExtensions' => '');
