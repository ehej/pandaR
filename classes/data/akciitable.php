...
class AkciiTable extends AbstractTable {

	function AkciiTable(&$connection) {
		parent::AbstractTable($connection, DB_TABLE_AKCII);
		
		$this->addTableField('intAkciyID', DB_COLUMN_NUMERIC, true);
