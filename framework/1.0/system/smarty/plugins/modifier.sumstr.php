...
$GLOBALS['sumstr_ua']['kopeek'][1]="копійка ";
$GLOBALS['sumstr_ua']['kopeek'][2]="копійки ";
$GLOBALS['sumstr_ua']['kopeek'][3]="копійок ";

//Kazakhstan
$GLOBALS['sumstr_kz']['_1_2'][1]="одна ";
$GLOBALS['sumstr_kz']['_1_2'][2]="две ";

$GLOBALS['sumstr_kz']['_1_19'][1]="один ";
$GLOBALS['sumstr_kz']['_1_19'][2]="два ";
$GLOBALS['sumstr_kz']['_1_19'][3]="три ";
$GLOBALS['sumstr_kz']['_1_19'][4]="четыре ";
$GLOBALS['sumstr_kz']['_1_19'][5]="пять ";
$GLOBALS['sumstr_kz']['_1_19'][6]="шесть ";
$GLOBALS['sumstr_kz']['_1_19'][7]="семь ";
$GLOBALS['sumstr_kz']['_1_19'][8]="восемь ";
$GLOBALS['sumstr_kz']['_1_19'][9]="девять ";
$GLOBALS['sumstr_kz']['_1_19'][10]="десять ";

$GLOBALS['sumstr_kz']['_1_19'][11]="одиннацать ";
$GLOBALS['sumstr_kz']['_1_19'][12]="двенадцать ";
$GLOBALS['sumstr_kz']['_1_19'][13]="тринадцать ";
$GLOBALS['sumstr_kz']['_1_19'][14]="четырнадцать ";
$GLOBALS['sumstr_kz']['_1_19'][15]="пятнадцать ";
$GLOBALS['sumstr_kz']['_1_19'][16]="шестнадцать ";
$GLOBALS['sumstr_kz']['_1_19'][17]="семнадцать ";
$GLOBALS['sumstr_kz']['_1_19'][18]="восемнадцать ";
$GLOBALS['sumstr_kz']['_1_19'][19]="девятнадцать ";

$GLOBALS['sumstr_kz']['des'][2]="двадцать ";
$GLOBALS['sumstr_kz']['des'][3]="тридцать ";
$GLOBALS['sumstr_kz']['des'][4]="сорок ";
$GLOBALS['sumstr_kz']['des'][5]="пятьдесят ";
$GLOBALS['sumstr_kz']['des'][6]="шестьдесят ";
$GLOBALS['sumstr_kz']['des'][7]="семьдесят ";
$GLOBALS['sumstr_kz']['des'][8]="восемьдесят ";
$GLOBALS['sumstr_kz']['des'][9]="девяносто ";

$GLOBALS['sumstr_kz']['hang'][1]="сто ";
$GLOBALS['sumstr_kz']['hang'][2]="двести ";
$GLOBALS['sumstr_kz']['hang'][3]="триста ";
$GLOBALS['sumstr_kz']['hang'][4]="четыреста ";
$GLOBALS['sumstr_kz']['hang'][5]="пятьсот ";
$GLOBALS['sumstr_kz']['hang'][6]="шестьсот ";
$GLOBALS['sumstr_kz']['hang'][7]="семьсот ";
$GLOBALS['sumstr_kz']['hang'][8]="восемьсот ";
$GLOBALS['sumstr_kz']['hang'][9]="девятьсот ";

$GLOBALS['sumstr_kz']['namerub'][1]="тенге ";
$GLOBALS['sumstr_kz']['namerub'][2]="тенге ";
$GLOBALS['sumstr_kz']['namerub'][3]="тенге ";

$GLOBALS['sumstr_kz']['nametho'][1]="тысяча ";
$GLOBALS['sumstr_kz']['nametho'][2]="тысячи ";
$GLOBALS['sumstr_kz']['nametho'][3]="тысяч ";

$GLOBALS['sumstr_kz']['namemil'][1]="миллион ";
$GLOBALS['sumstr_kz']['namemil'][2]="миллиона ";
$GLOBALS['sumstr_kz']['namemil'][3]="миллионов ";

$GLOBALS['sumstr_kz']['namemrd'][1]="миллиард ";
$GLOBALS['sumstr_kz']['namemrd'][2]="миллиарда ";
$GLOBALS['sumstr_kz']['namemrd'][3]="миллиардов ";

$GLOBALS['sumstr_kz']['kopeek'][1]="тиын ";
$GLOBALS['sumstr_kz']['kopeek'][2]="тиын ";
$GLOBALS['sumstr_kz']['kopeek'][3]="тиын ";

function smarty_sumstr_semantic($i,&$words,&$fem,$f,$default_lang){
...
function smarty_modifier_sumstr($L, $default_lang = 'ru') {
	$_1_2 = $GLOBALS['sumstr_'.$default_lang]['_1_2'];
	$_1_19 = $GLOBALS['sumstr_'.$default_lang]['_1_19'];
	$des = $GLOBALS['sumstr_'.$default_lang]['des'];
	$hang = $GLOBALS['sumstr_'.$default_lang]['hang'];
	...
	if($L>=1000000000){
		$many=0;
		smarty_sumstr_semantic(intval($L / 1000000000),$s1,$many,3, $default_lang);
		$s.=$s1.$namemrd[$many];
		$L%=1000000000;
	}
	...
	if($L >= 1000000){
		$many=0;
		smarty_sumstr_semantic(intval($L / 1000000),$s1,$many,2,$default_lang);
		$s.=$s1.$namemil[$many];
		$L%=1000000;
		if($L==0){
			$s.=$namerub[1];
	...
	if($L >= 1000){
		$many=0;
		smarty_sumstr_semantic(intval($L / 1000),$s1,$many,1,$default_lang);
		$s.=$s1.$nametho[$many];
		$L%=1000;
		if($L==0){
			$s.=$namerub[3];
	...
	if($L != 0){
		$many=0;
		smarty_sumstr_semantic($L,$s1,$many,0,$default_lang);
		$s.=$s1.$namerub[$many];
	}

	if($kop > 0){
		$many=0;
		smarty_sumstr_semantic($kop,$s1,$many,1,$default_lang);
		$s.=$s1.$kopeek[$many];
	}
	else {
		$s.=" 00 ".$kopeek[3];
