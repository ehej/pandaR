...
class Session {
	...
	function Session($SessionID = null) {
		...
		if (SESSION_SAVE_HANDLER === 'files') {
			...
			$this->SessionStorage = PhpSession::getInstance($this->SessionID);
		}
	}
...
class PhpSession {
	...
	protected function __construct($SessionID = null) {
		session_name($SessionID);
		session_start();
	}

	static function getInstance($SessionID = null){
		if(isset(self::$instance)){
			return self::$instance;
		}else{
			return self::$instance = new PhpSession($SessionID);
		}
	}
