...
class IndexPage extends AdminPage {
	...
	function index() {
		...
		$this->setBoldMenu('seminarorders');
	...
	function OnDelete() {
		...
		$this->response->redirect('seminarorders.php?page='.$this->page);
	}
	...
	function render() {
		...
		else $sort['intSeminarOrderID'] = 'DESC';
		...
		$applications_list = $this->SeminarOrdersTable->GetList($this->sfilter, $sort, null, null, null, true, $this->page, 20);		
...
Kernel::ProcessPage(new IndexPage("seminarorders.tpl"));